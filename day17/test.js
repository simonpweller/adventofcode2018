...
describe('simulate', () => {
  it('updates the map with flowing while there is space below', () => {
    const expectedMap = [
      ['.', '.', '.', '.', '.', '.', '+', '.', '.', '.', '.', '.', '.', '.',],
      ['.', '.', '.', '.', '.', '.', '|', '.', '.', '.', '.', '.', '#', '.',],
      ['.', '#', '.', '.', '#', '.', '|', '.', '.', '.', '.', '.', '#', '.',],
    ...
    expect(simulate(lines, 5)).toEqual(expectedMap);
  });

  it('updates the map with resting water if it hits clay', () => {
    const expectedMap = [
      ['.', '.', '.', '.', '.', '.', '+', '.', '.', '.', '.', '.', '.', '.',],
      ['.', '.', '.', '.', '.', '.', '|', '.', '.', '.', '.', '.', '#', '.',],
      ['.', '#', '.', '.', '#', '.', '|', '.', '.', '.', '.', '.', '#', '.',],
    ...
    expect(simulate(lines, 6)).toEqual(expectedMap);
  });
});
